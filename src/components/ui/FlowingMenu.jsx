...
/* ============================================================
   FlowingMenu · React Bits 组件适配波普主题
   - 每行 hover 触发上下切入的彩色跑马灯覆盖层
   - 跑马灯背景色取自 item.accent（青/玫红），文字反白为 void
   - 静态行保留 公司名 / 角色·周期 / 标签 三层信息
   ============================================================ */
...
function MenuItem({
  ...
  // 跑马灯配色：背景取 accent，文字反白为 void
  const marqueeBgColor = accent;
  const marqueeTextColor = '#0C0C0C';
