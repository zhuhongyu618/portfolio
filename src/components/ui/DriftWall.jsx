  ...
  const renderTile = (item, id, colIndex) => {
    const inner = (
      <span className="drift-wall__inner">
        ...
        />
        {item.subtitle && (
          <span className="drift-wall__subtitle">
            {item.subtitle.label && <span className="dw-label">{item.subtitle.label}</span>}
            {item.subtitle.value && <span className="dw-value">{item.subtitle.value}</span>}
            {item.subtitle.desc && <span className="dw-desc">{item.subtitle.desc}</span>}
          </span>
        )}
